...
print(f"Knowledge text length: {len(knowledge_text)} characters")
print("Chunking the knowledge text...")
...
print(f"✅ Embedding complete. Processed {len(embeddings)} chunks.")

prompt = "What is the podcast that Clara hosts about?"
print(f"\nPrompt: {prompt}")
print("Searching for relevant knowledge and generating response...")
...
print("The RAG agent performed the following steps:")
print("1. Chunked the large knowledge text into manageable pieces")
print("2. Created embeddings for each chunk using text-embedding-3-large")
print("3. Created an embedding for the user's prompt")
print("4. Found the most similar chunk using cosine similarity")
print("5. Used only that relevant chunk to answer the question")
print("6. Applied the professor persona to format the response")
print("This demonstrates how RAG enables knowledge retrieval from large corpora!")
